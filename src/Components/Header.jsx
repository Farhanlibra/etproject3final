  ...
  return (
    <div>
        ...
        <div className=' text-white text-xl  py-8'>
          <Link className='text-[24px] sm: mr-2 sm:ml-1 sm:text-[8px] lg:text-[20px] lg:mr-[680px] lg:ml-9 font-bold' to='/home'>FARAME</Link>
          ...
          <Link className='sm:text-[8px] lg:text-[18px] sm:mr-1 lg:mr-5' to='/contact'>CONTACT</Link>
          <Link className='sm:text-[8px] lg:text-[18px] sm:mr-1 lg:mr-5' to='/price'>PRICE</Link>
          <Link className='sm:text-[8px] lg:text-[18px] sm:mr-1 lg:mr-5' to='/review'>REVIEW</Link>
        </div>
