  ...
  return (
    <div>
        ...
        <div className=' text-white text-xl  py-8'>
          <Link className='text-[24px] sm: mr-2 sm:ml-1 sm:text-sm lg:mr-[680px] lg:ml-9 font-bold' to='/home'>FARAME</Link>
          <Link className='text-[18px] mr-5' to='/'>HOME</Link>
          <Link className='text-[18px] mr-5' to='/feature'>FEATURE</Link>
          <Link className='text-[18px] mr-5' to='/contact'>CONTACT</Link>
          <Link className='text-[18px] mr-5' to='/price'>PRICE</Link>
          <Link className='text-[18px] mr-5' to='/review'>REVIEW</Link>
        </div>
