  ...
  return (
    <div className='max-w-screen-2xl  bg-slate-400 h-auto  mt-[30px] ml-0 px-0 '>
        ...
        <div className=' w-[400px] lg:ml-10 sm:ml-1 order-2 lg:order-2'>
            <h1 className='text-blue-950 font-bold text-[28px] mb-4  sm:text-[14px] lg:ml-16'> Big Benefits for Small Business</h1>
        ...
        <div className=' w-[400px] ml-10  sm:ml-0 order-4 lg:order-3'>
        <h1 className='text-blue-950 font-bold text-[28px] mb-4  sm:text-[14px] :lg:ml-16'> Big Benefits for Small Business</h1>
        ...
        <h1 className='text-blue-950 font-bold text-[28px] mb-4 sm:ml-0 sm:text-[14px] lg:ml-16'> Big Benefits for Small Business</h1>
