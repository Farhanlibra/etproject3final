...
const Feature = () => {
  return (
    <div className='max-w-screen-2xl  bg-slate-400 h-auto  mt-[30px] ml-0 sm:px-5 '>
        ...
        <div className=' w-[400px] lg:ml-10 sm:ml-6 order-2 lg:order-2'>
            <h1 className='text-blue-950 font-bold lg:text-[28px] mb-4  sm:text-[14px] sm:pl-10 lg:ml-16'> Big Benefits for Small Business</h1>
        ...
        <h1 className='text-blue-950 font-bold lg:text-[28px] mb-4  sm:text-[14px] sm:pl-6 lg:ml-16 '> Big Benefits for Small Business</h1>
            <p className='lg:ml-16  leading-6'>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
            <ul className='mt-8 ml-20 mb-20 list-disc '>
              <li className='leading-10'>
              Pointing has no control 
              </li>
