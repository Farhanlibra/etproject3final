  ...
  return (
    <div className='max-w-screen-2xl  bg-slate-400 h-auto  mt-[30px] ml-0 px-0 '>
        ...
        <div className=' w-[400px] ml-10 sm:max-w-full order-2 lg:order-2'>
            <h1 className='text-blue-950 font-bold text-[28px] mb-4 sm:ml-6 sm:text-[14px] lg:ml-16'> Big Benefits for Small Business</h1>
        ...
        <h1 className='text-blue-950 font-bold text-[28px] mb-4 sm:ml-2 sm:text-[14px] lg:ml-16'> Big Benefits for Small Business</h1>
